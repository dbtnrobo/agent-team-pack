# === VENDORED (unmodified) ===
# Source: zilliztech/memsearch (MIT, Copyright (c) 2025 Zilliz Inc.) — commit 018a85f
#   file: src/memsearch/chunker.py
#   License: THIRD_PARTY_LICENSES/memsearch-LICENSE.txt
# Provides: Chunk, chunk_markdown(), compute_chunk_id() — 見出し単位のmd分割（日本語文境界分割込み）
# 改変禁止: 上流追従のためここは手を入れない。調整は呼び出し側(fts_index.py)で行う。
